...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `197.8µs` | `1.5ms` |
| [Day 2](./src/bin/02.rs) | `67.0µs` | `63.1µs` |
| [Day 3](./src/bin/03.rs) | `5.9ms` | `7.3ms` |
| [Day 4](./src/bin/04.rs) | `586.4µs` | `586.4µs` |
| [Day 6](./src/bin/06.rs) | `736.0ns` | `28.5ms` |
