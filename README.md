...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `205.0µs` | `1.6ms` |
| [Day 2](./src/bin/02.rs) | `68.1µs` | `64.4µs` |
| [Day 3](./src/bin/03.rs) | `6.0ms` | `7.5ms` |
| [Day 4](./src/bin/04.rs) | `545.0µs` | `545.3µs` |
| [Day 6](./src/bin/06.rs) | `768.0ns` | `413.0ns` |
| [Day 7](./src/bin/07.rs) | `4.4ms` | `4.5ms` |
