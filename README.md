...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `191.7µs` | `1.5ms` |
| [Day 2](./src/bin/02.rs) | `65.1µs` | `61.6µs` |
| [Day 3](./src/bin/03.rs) | `5.6ms` | `7.1ms` |
| [Day 4](./src/bin/04.rs) | `558.7µs` | `571.8µs` |
| [Day 6](./src/bin/06.rs) | `623.0ns` | `348.0ns` |
| [Day 7](./src/bin/07.rs) | `4.5ms` | `4.6ms` |
| [Day 8](./src/bin/08.rs) | `449.9µs` | `4.8ms` |
